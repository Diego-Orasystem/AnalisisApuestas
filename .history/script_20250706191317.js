...
function isBettingGame(game) {
    ...
    // Solo necesita cumplir con la diferencia de puntos (cualquier período)
...
// Función para mostrar notificación de nuevos partidos de apuestas
function showBettingNotification(count) {
    // Crear elemento de notificación
    const notification = document.createElement('div');
    notification.className = 'betting-notification';
